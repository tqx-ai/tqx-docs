...
##### 6.4.1. Get the latest tick data of a stock
...
##### 6.4.2. Get the latest tick data of all Hong Kong stocks
...
##### 6.4.3. Get the latest tick data of U.S. stocks
