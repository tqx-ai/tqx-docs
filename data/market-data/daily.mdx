...
### 1. Obtain daily data of Hong Kong stocks

#### 1.1. Method name: get_hk_daily
...
##### 1.4.1. Obtain daily data of all Hong Kong stocks within a certain date
...
##### 1.4.2. Obtain the daily data of some Hong Kong stocks within a certain date and limit the return fields
...
### 2. Get daily data of US stocks

#### 2.1. Method name: get_us_daily
...
##### 2.4.1. Obtain daily data of all US stocks within a certain date
...
##### 2.4.2. Obtain the daily data of some US stocks within a certain date and limit the return fields
