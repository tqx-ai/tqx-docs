...
### 8. Obtain the company’s investor concentration ratio

#### 8.1. Method name: get_company_concentration

#### 8.2. Enter parameters
...
##### 8.4.1. Obtain investor concentration data of all Hong Kong stock companies
...
### 9. Obtain the concentration ratio of the top 20 investors in the company

#### 9.1. Method name: get_company_top_concentration

#### 9.2. Enter parameters
...
##### 9.4.1. Obtain investor concentration data of all Hong Kong stock companies
...
### 10. Obtain the ranking of company investors

#### 10.1. Method name: get_company_investor

#### 10.2. Enter parameters
...
##### 10.4.1. Obtain the top 10 investor data of all Hong Kong stock companies
...
### 11. Obtain company insider trading activity

#### 11.1. Method name: get_company_insider_transaction

#### 11.2. Enter parameters
...
##### 11.4.1. Obtain insider trading activities of a Hong Kong stock company within a certain period of time
...
### 12. Obtain the company’s shareholder shareholding report

#### 12.1. Method name: get_company_shareholder_report

#### 12.2. Enter parameters
...
##### 12.4.1. Obtain the shareholder shareholding report of a certain Hong Kong stock company within a certain period of time
