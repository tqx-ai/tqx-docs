...
### 18. Obtain consensus expectations of non-cyclical indicators

#### 18.1. Method name: get_consensus_nonperiod

#### 18.2. Enter parameters
...
##### 18.4.1. Obtain some consensus expectations of all Hong Kong stock non-cyclical indicators
...
### 19. Obtain consensus expectations for buying and selling recommendations

#### 19.1. Method name: get_consensus_recommend

#### 19.2. Enter parameters
...
##### 19.4.1. Obtain some consensus expectations for all Hong Kong stock trading recommendations
