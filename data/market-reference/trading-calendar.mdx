...
#### 2.1. Method name: get_trading_calendar
...
##### 2.4.1. Obtain the Hong Kong stock trading calendar within a period of time
...
##### 2.4.2. Get US stock non-trading days within a period of time and use fields
...
##### 2.4.3. Get Hong Kong stock trading days within a period of time
