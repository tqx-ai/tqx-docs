...
#### 4.1. 方法名稱：get_event_capital_market
...
#### 5.1. 方法名稱：get_event_corporate_actions
...
#### 6.1. 方法名稱：get_event_fina_disclosure
...
#### 7.1. 方法名稱：get_event_investor_relation_activities
